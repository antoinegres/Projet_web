...
if(isset($_POST['submit_recherche'])){
	if(($_POST['recherche_nom']) && ($_POST['recherche_prenom'])){
		...
		$recherche_prenom= htmlspecialchars($_POST['recherche_nom']);
		$req = $bdd->prepare("SELECT * FROM test WHERE nom= ? AND prenom= ?");
...
<html>
	...
	<p>hgh</p>
		<div id="corps" align="center">
			...
			?>
				<p>
				<strong>Ami</strong> : <a href=Connection.php><?php echo $donnees['nom']; ?>   <?php echo $donnees['prenom']; ?></a>
			   </p>
			<?php
			}
